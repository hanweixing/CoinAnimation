...
-(IBAction) flipTouched:(id)sender{
    if(animationTimer == nil){
        animationTimer = [NSTimer scheduledTimerWithTimeInterval:0.05 target:self selector:@selector(animationAction) userInfo:nil repeats:YES];
    }
}
